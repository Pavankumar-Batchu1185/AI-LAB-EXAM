...
pair<int,int> findBestMove(char board[3][3])
{
    ...
    cout << "[Minimax] Best move H-value: " << bestVal << "\n";
    return bestMove;
}
...
int main()
{
    ...
    cout << "=== AI Tic Tac Toe (Program 3 - Minimax) ===\n";
    cout << "AI is X (maximizes H), You are O (minimizes H).\n";
    cout << "H = P(X wins) - P(O wins). AI picks move with max H.\n\n";
    ...
    while (getWinner(board) == ' ' && movesLeft(board))
    {
        ...
        {
            cout << "AI (X) thinking using Minimax...\n";
